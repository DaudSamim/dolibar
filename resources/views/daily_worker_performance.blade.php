         ...
         <div class="card-body">
            ...
            <form class="forms-sample"action="/daily_worker_performance" method="post"enctype='multipart/form-data'>
               ...
               <div class="form-group form-inline-custom">
                  ...
                  <input type="text"value="{{old('requirements')}}"class="form-control" id="exampleInputPassword1"name="requirements" autocomplete="off" placeholder="" aria-autocomplete="list">
               </div>

               <div class="form-group form-inline-custom">
                  <label for="exampleInputPassword1">Tiempo de trabajo</label>
                  <input type="text"value="{{old('working_time')}}"class="form-control" id="exampleInputPassword1"name="working_time"maxlength = "19" autocomplete="off" placeholder="" aria-autocomplete="list">
               </div>

               <div class="form-group form-inline-custom">
                  <label for="exampleInputPassword1">Unidades terminadas</label>
                  <input type="number" value="{{old('finished_units')}}"class="form-control" id="exampleInputPassword1"name="finished_units" autocomplete="off" placeholder="" aria-autocomplete="list">
               </div>

               <div class="form-group form-inline-custom">
                  <label for="exampleInputPassword1">Cumplimiento del objetivo</label>
                   <select style="width: 75% !important" value="{{old('objective')}}" class="js-example-basic-single w-100 select2-hidden-accessible"name="objective" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
               ...
               <div class="form-group form-inline-custom">
                  ...
                  <input type="number" class="form-control"value="{{old('faulty_units')}}" id="exampleInputPassword1"name="faulty_units" autocomplete="off" placeholder="" aria-autocomplete="list">
               </div>

               <div class="form-group form-inline-custom">
                  <label for="exampleInputPassword1">Pérdida Valorizada </label>
                  <input type="number" class="form-control"value="{{old('valued_loss')}}" id="exampleInputPassword1"name="valued_loss" autocomplete="off" placeholder="" aria-autocomplete="list">
               </div>

               <div class="form-group form-inline-custom">
                  <label for="exampleInputPassword1">Comentario </label>
                  <input type="text" class="form-control"value="{{old('commentary')}}" id="exampleInputPassword1"name="commentary" autocomplete="off" placeholder="" aria-autocomplete="list">
               </div>
